...
exports.createContrato = [
  ...
  async (req, res) => {
    ...
    if (!descripcion || !id_cliente || !estado || !fecha_inicio) {
    ...
    try {
      ...
      const [result] = await db.query(
        "INSERT INTO contrato (descripcion, id_cliente, referencia_diseño, estado, fecha_inicio) VALUES (?, ?, ?, ?, ?)",
        [descripcion, id_cliente, referencia_diseño, estado, fecha_inicio]
      );
